-- Read Code Index
INSERT IGNORE INTO tool_catalog (id, tool_key, name, description, tool_type, risk_level, execution_mode, enabled, built_in, parameter_schema_json, create_time, update_time)
