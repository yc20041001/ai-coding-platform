...
@TableName("governance_simulation_result")
public class GovernanceSimulationResultEntity implements Serializable {
    @TableId(type = IdType.ASSIGN_ID) private Long id;
    private Long scenarioId; private String resultStatus;
    ...
    public Long getScenarioId() { return scenarioId; } public void setScenarioId(Long v) { this.scenarioId = v; }
