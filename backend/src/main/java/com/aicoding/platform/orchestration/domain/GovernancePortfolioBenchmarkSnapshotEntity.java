...
@TableName("governance_portfolio_benchmark_snapshot")
public class GovernancePortfolioBenchmarkSnapshotEntity implements Serializable {
    @TableId(type = IdType.ASSIGN_ID) private Long id;
    private LocalDate snapshotDate; private String benchmarkWindow; private String metricKey;
    private BigDecimal metricValue; private BigDecimal percentileRank; private BigDecimal peerAvg;
    private BigDecimal peerP90; private Integer sampleCount; private String signalLevel;
